  ...
  export const TODOS_RESET_EDITING = 'TODOS_RESET_EDITING'
  export const TODOS_GET_MANY = 'TODOS_GET_MANY'
  export const TODOS_GET_SINGLE = 'TODOS_GET_SINGLE'
  export const TODOS_GOT_SINGLE = 'TODOS_GOT_SINGLE'
